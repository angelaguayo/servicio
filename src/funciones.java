...
public class funciones extends mysql {
    ...
    void agregarNuevo(String codigo, String nombre, String apellido, String edad, String domicilio,String turno,String fecha) throws SQLException {
        ...
        String query7="insert into ingreso values ('"+codigo+"','"+fecha+"');";
        this.ejecutar(query7);
